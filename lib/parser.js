...
var rules = [
    ...
    get('Pub', 'fn', 'Name', 'LeftPar', 'ParameterList', 'RightPar', 'LeftHandlebar', 'CompositeExpression', 'RightHandlebar').generate('Function',
        function (values) { return new FunctionExpression(values[2].getName(), values[4], values[7]); }),
    
    // Module
    get('mod', 'Name', 'LeftHandlebar', 'CompositeExpression', 'RightHandlebar').generate('Module',
