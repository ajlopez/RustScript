...
function PatternExpression(head, expr) {
}
...
var rules = [
    ...
    // Match
    get('match', 'Expression', 'LeftHandlebar', 'PatternList', 'RightHandlebar').generate('BracketExpression', function (values) { return new MatchExpression(values[1], values[3]); }),
