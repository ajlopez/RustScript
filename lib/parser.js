...
var rules = [
    ...
    // Expression List
    get('ExpressionList').generate('CompositeExpression', function (value) { console.log('CompositeExpression'); console.dir(value); return new CompositeExpression(value); }),
    peek('RightHandlerbar').generate('ExpressionList', function (values) { return [] }),
    get('Expression'/*, peek('RightHandlerbar')*/).generate('ExpressionList', function (value) { console.log('Expression }'); console.dir(value); return [ value ]; }),
    //get('Expression', 'SemiColon', peek('RightHandlerbar')).generate('ExpressionList', function (values) { return [ values[0], null ]; }),
    //get('Expression', 'SemiColon', 'ExpressionList').generate('ExpressionList', function (values) { var list = values[2]; list.unshift(values[1]); return list; }),
