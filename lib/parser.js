...
const simplegrammar = require('simplegrammar');
const expressions = require('./expressions');

const get = simplegrammar.get;
const peek = simplegrammar.peek;

const QualifiedNameExpression = expressions.QualifiedNameExpression,
...
const rules = [
    ...
    // Integer
    get('0-9').oneOrMore().and(get('i').zeroOrOne()).generate('Integer', function (value) { return expressions.constant(parseInt(value)) }),
    ...
    get('CommandList').generate('Program', function (value) { return expressions.composite(value); }),
    ...
    get('fn', 'Name', 'LeftPar', 'ParameterList', 'RightPar', 'LeftHandlebar', 'CompositeExpression', 'RightHandlebar').generate('Function',
        function (values) { return expressions.function(values[1].getName(), values[3], values[6]); }),
    // TODO Review
    ...
    get('Pub', 'fn', 'Name', 'LeftPar', 'ParameterList', 'RightPar', 'LeftHandlebar', 'CompositeExpression', 'RightHandlebar').generate('Function',
        function (values) { return expressions.function(values[2].getName(), values[4], values[7], { public: true }); }),
    ...
    // Return
    get('return', 'Expression').generate('Expression', function (values) { return expressions.return(values[1]); }),
    get('return').generate('Expression', function (values) { return expressions.return(null); }),
    ...
    // While
    get('while', 'Expression', 'LeftHandlebar', 'CompositeExpression', 'RightHandlebar').generate('BracketExpression', function (values) { return expressions.while(values[1], values[3]); }),
    ...
    // For
    get('for', 'Name', 'in', 'Expression', 'LeftHandlebar', 'CompositeExpression', 'RightHandlebar').generate('BracketExpression', function (values) { return expressions.for(values[1].getName(), values[3], values[5]); }),
     
    // Loop
    get('loop', 'LeftHandlebar', 'CompositeExpression', 'RightHandlebar').generate('BracketExpression', function (values) { return expressions.loop(values[2]); }),
    ...
    get('if', 'Expression', 'LeftHandlebar', 'CompositeExpression', 'RightHandlebar', 'else', 'LeftHandlebar', 'CompositeExpression', 'RightHandlebar').generate('IfExpression',
        function (values) { return expressions.if(values[1], values[3], values[7]);  }),
    get('if', 'Expression', 'LeftHandlebar', 'CompositeExpression', 'RightHandlebar', 'else', 'IfExpression').generate('IfExpression',
        function (values) { return expressions.if(values[1], values[3], values[6]);  }),
    get('if', 'Expression', 'LeftHandlebar', 'CompositeExpression', 'RightHandlebar').generate('IfExpression',
        function (values) { return expressions.if(values[1], values[3]); }),
        
    // Expression List
    get('ExpressionList').generate('CompositeExpression', function (value) { return expressions.composite(value); }),
    ...
    // Assign to variable
    get('Name', 'Assign', 'Expression').generate('Expression', function (values) { return expressions.assign(values[0].getName(), values[2]); }),
    
    // Or Expression Level 6
    get('Expression6').generate('Expression'),
    get('Expression6', 'Or', 'Expression5').generate('Expression6', function (values) { return expressions.or(values[0], values[2]); }),
    
    // And Expression Level 5
    get('Expression5').generate('Expression6'),
    get('Expression5', 'And', 'Expression4').generate('Expression5', function (values) { return expressions.and(values[0], values[2]); }),
    ...
    get('Expression3', 'BitwiseOr', 'Expression2').generate('Expression3', function (values) { return expressions.bitwiseOr(values[0], values[2]); }),

    // Bitwise And Expression Level 2
    get('Expression2').generate('Expression3'),
    get('Expression2', 'BitwiseAnd', 'Expression1').generate('Expression2', function (values) { return expressions.bitwiseAnd(values[0], values[2]); }),
    ...
    get('Expression0', 'Module', 'Term').generate('Expression0', function (values) { return expressions.mod(values[0], values[2]); }),
    ...
    get('Term', 'LeftPar', 'Arguments', 'RightPar').generate('Term', function (values) { return expressions.call(values[0], values[2]); }),
    ...
    get('ArgumentList').generate('Arguments', function (value) { return expressions.arguments(value); }),
