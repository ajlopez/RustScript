...
function ModuleExpression(left, right) {
    this.evaluate = function (context) {
        return left.evaluate(context) % right.evaluate(context);
    };
}
...
var rules = [
    ...
    get('Expression3', 'Equal', 'Expression2').generate('Expression3', function (values) { return new EqualExpression(values[0], values[2]); }),
    get('Expression3', 'NotEqual', 'Expression2').generate('Expression3', function (values) { return new NotEqualExpression(values[0], values[2]); }),
    get('Expression3', 'LessEqual', 'Expression2').generate('Expression3', function (values) { return new LessEqualExpression(values[0], values[2]); }),
    get('Expression3', 'GreaterEqual', 'Expression2').generate('Expression3', function (values) { return new GreaterEqualExpression(values[0], values[2]); }),
    get('Expression3', 'Less', 'Expression2').generate('Expression3', function (values) { return new LessExpression(values[0], values[2]); }),
    get('Expression3', 'Greater', 'Expression2').generate('Expression3', function (values) { return new GreaterExpression(values[0], values[2]); }),
    
    // Bitwise Or Expression Level 2
    get('Expression2').generate('Expression3'),
    get('Expression2', 'BitwiseOr', 'Expression1').generate('Expression2', function (values) { return new BitwiseOrExpression(values[0], values[2]); }),
    ...
    get('Expression0', 'Module', 'Term').generate('Expression0', function (values) { return new ModuleExpression(values[0], values[2]); }),
